...
def insert_books_data_into_postgres(ti):
...
dag  = DAG(
    ...
    description='A simple DAG to fetch book data from Amazon and store it in PostgreSQL',
...
insert_book_data_task = PythonOperator(
    ...
    python_callable=insert_books_data_into_postgres,
    dag=dag,
)
